...
public class CedaView extends JFrame {
	...
	private Font f4 = new Font("-¿±∞ÌµÒ320",Font.PLAIN,150);
	public CedaView(){
		super("CEDA");
		Init();
	}
	...
	public void setTC(int i){
		if (i ==1){
			...
			lMinute.setForeground(Color.black);
			lSecond.setForeground(Color.BLACK);
			lMilli.setForeground(Color.black);
		}
